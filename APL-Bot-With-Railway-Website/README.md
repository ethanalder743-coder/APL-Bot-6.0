...
Add a long private `WEB_ADMIN_KEY` in Railway Variables. After deployment, open the service's Railway domain and choose **Admin** to enter that key. Do not share it or put its real value in GitHub.
...
WEB_ADMIN_KEY=replace_with_a_long_private_password
```
